...
def _unet(n_classes, encoder, l1_skip_conn=True, input_height=864,
          input_width=480):
...
def unet(n_classes, input_height=864, input_width=480, encoder_level=3):
...
def vgg_unet(n_classes, input_height=864, input_width=480, encoder_level=3):
...
def resnet50_unet(n_classes, input_height=1024, input_width=1024,
                  encoder_level=3):
