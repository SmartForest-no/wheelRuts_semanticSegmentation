...
def pspnet(n_classes,  input_height=832, input_width=448):
...
def resnet50_pspnet(n_classes,  input_height=832, input_width=448):
...
def pspnet_101(n_classes,  input_height=832, input_width=448):
    from ._pspnet_2 import _build_pspnet
