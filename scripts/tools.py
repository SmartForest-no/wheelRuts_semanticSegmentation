...
##########################################################################################################################################################################
def predict_wheelRuts(png_dir, model_dir, model_name):
    ...
    #os.chdir(model_dir)
    print("Model directory ................................"+model_dir+ model_name)
    # run inference
    predict_multiple( 
      checkpoints_path=model_dir + model_name , #path to weights (stored model .json file)
